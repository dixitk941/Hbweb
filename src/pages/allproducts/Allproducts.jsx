...
const AllProducts = () => {
    ...
    const { mode, product, searchkey, setSearchkey, filterType, setFilterType, filterPrice, setFilterPrice, getAllProduct } = context;
    ...
    const addCart = (product) => {
        ...
        // Assuming `toast` is imported from somewhere else
                    ...
                    <div className="flex flex-wrap -m-4">
                        {product.filter((obj) => obj.title.toLowerCase().includes(searchkey))
                            ...
                            .filter((obj) => obj.price.includes(filterPrice)).map((item, index) => {
                                ...
                                return (
                                    <div onClick={() => navigate(`/productinfo/${id}`)} key={index} className="p-4 md:w-1/4  drop-shadow-lg">
