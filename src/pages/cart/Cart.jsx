...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "TEST101600724424b7d83c0f399dc44927006101",
      key_secret: "cfsk_ma_test_f3e6464f988a65f0f353ee1dddb91c3f_bf59d626",
      ...
      <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
        <div className="rounded-lg md:w-2/3 ">
          {cartItems.map((item, index) => {
            const { title, price, description, coverImageUrl } = item; // Updated to use coverImageUrl
            return (
              <div className="justify-between mb-6 rounded-lg border  drop-shadow-xl bg-white p-6  sm:flex  sm:justify-start" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
                <img src={coverImageUrl} alt="product-image" className="w-full rounded-lg sm:w-40" /> {/* Updated to use coverImageUrl */}
