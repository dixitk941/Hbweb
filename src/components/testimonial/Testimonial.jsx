                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase" style={{ color: mode === 'dark' ? '#ff4162' : '' }}>Prachi Dixit</h2>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase" style={{ color: mode === 'dark' ? '#ff4162' : '' }}>Rohit Sharma</h2>
                                <p className="text-gray-500" style={{ color: mode === 'dark' ? 'white' : '' }}>Customer</p>
                            </div>
                        </div>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase" style={{ color: mode === 'dark' ? '#ff4162' : '' }}>Sneha Verma</h2>
                                <p className="text-gray-500" style={{ color: mode === 'dark' ? 'white' : '' }}>Customer</p>
                            </div>
                        </div>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase" style={{ color: mode === 'dark' ? '#ff4162' : '' }}>Amit Patel</h2>
                                <p className="text-gray-500" style={{ color: mode === 'dark' ? 'white' : '' }}>Customer</p>
                            </div>
                        </div>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase" style={{ color: mode === 'dark' ? '#ff4162' : '' }}>Neha Kapoor</h2>
                                <p className="text-gray-500" style={{ color: mode === 'dark' ? 'white' : '' }}>Customer</p>
                            </div>
                        </div>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 p-4">
                            <div className="h-full text-center">
                                ...
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase" style={{ color: mode === 'dark' ? '#ff4162' : '' }}>Ravi Kumar</h2>
                                <p className="text-gray-500" style={{ color: mode === 'dark' ? 'white' : '' }}>Customer</p>
                            </div>
                        </div>
                    </div>
