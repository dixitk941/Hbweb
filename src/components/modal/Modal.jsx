...
export default function Modal({ name, address, pincode, phoneNumber, size, setName, setAddress, setPincode, setPhoneNumber, setSize, buyNow }) {
                                            ...
                                            <div className="w-full rounded-lg md:mt-0 sm:max-w-md xl:p-0 ">
                                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                                    <form className="space-y-4 md:space-y-6" action="#">
                                                        ...
                                                        <div>
                                                            <label htmlFor="size" className="block mb-2 text-sm font-medium text-gray-900">Enter Size</label>
                                                            <input value={size} onChange={(e)=>setSize(e.target.value)} type="text" name="size" id="size" className="border outline-0 border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 bg-gray-100" required />
                                                        </div>
                                                    </form>
